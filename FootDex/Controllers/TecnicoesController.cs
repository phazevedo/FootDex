...
namespace FootDex.Controllers
{
    public class TecnicoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nome,DataNascimento")] Tecnico tecnico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nome,DataNascimento")] Tecnico tecnico)
        {
            if (ModelState.IsValid)
            {
